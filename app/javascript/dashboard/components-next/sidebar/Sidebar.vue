...
const agentMenuItems = computed(() => {
  return [{
    ...
    label: 'Agente',
    icon: 'i-lucide-bot',
    to: accountScopedRoute('agent_settings'),
    activeOn: ['agent_settings', 'agent_settings_new', 'agent_settings_edit', 'agent_inboxes', 'agent_inboxes_edit', 'agent_knowledge', 'agent_knowledge_edit', 'agent_tools', 'agent_tools_edit'],
    children: [
      {
        name: 'Agent Settings',
        label: 'Configurações',
        ...
        to: accountScopedRoute('agent_settings'),
        activeOn: ['agent_settings', 'agent_settings_new', 'agent_settings_edit'],
      },
      {
        name: 'Agent Inboxes',
        label: 'Caixas de Entrada',
        icon: 'i-lucide-inbox',
        to: accountScopedRoute('agent_inboxes'),
        activeOn: ['agent_inboxes', 'agent_inboxes_edit'],
      },
      {
        name: 'Agent Knowledge',
        label: 'Conhecimento',
        icon: 'i-lucide-book',
        to: accountScopedRoute('agent_knowledge'),
        activeOn: ['agent_knowledge', 'agent_knowledge_edit'],
      },
      {
        name: 'Agent Tools',
        label: 'Ferramentas',
        icon: 'i-lucide-wrench',
        to: accountScopedRoute('agent_tools'),
        activeOn: ['agent_tools', 'agent_tools_edit'],
      },
    ],
  }];
});
