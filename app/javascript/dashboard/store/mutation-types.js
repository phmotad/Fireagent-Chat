export default {
  ...
  // Kanban
  SET_KANBAN_BOARD_UI_FLAG: 'SET_KANBAN_BOARD_UI_FLAG',
  SET_KANBAN_BOARDS: 'SET_KANBAN_BOARDS',
  ADD_KANBAN_BOARD: 'ADD_KANBAN_BOARD',
  EDIT_KANBAN_BOARD: 'EDIT_KANBAN_BOARD',
  DELETE_KANBAN_BOARD: 'DELETE_KANBAN_BOARD',
  SET_CURRENT_KANBAN_BOARD: 'SET_CURRENT_KANBAN_BOARD',
  SET_KANBAN_COLUMNS: 'SET_KANBAN_COLUMNS',
  ADD_KANBAN_COLUMN: 'ADD_KANBAN_COLUMN',
  EDIT_KANBAN_COLUMN: 'EDIT_KANBAN_COLUMN',
  DELETE_KANBAN_COLUMN: 'DELETE_KANBAN_COLUMN',
  SET_KANBAN_CARDS: 'SET_KANBAN_CARDS',
  ADD_KANBAN_CARD: 'ADD_KANBAN_CARD',
  EDIT_KANBAN_CARD: 'EDIT_KANBAN_CARD',
  DELETE_KANBAN_CARD: 'DELETE_KANBAN_CARD',
  MOVE_KANBAN_CARD: 'MOVE_KANBAN_CARD',
  SET_KANBAN_ARCHIVED_CARDS: 'SET_KANBAN_ARCHIVED_CARDS',
  DELETE_KANBAN_ARCHIVED_CARD: 'DELETE_KANBAN_ARCHIVED_CARD',
       SET_KANBAN_LOCATIONS: 'SET_KANBAN_LOCATIONS',
       ADD_KANBAN_LOCATION: 'ADD_KANBAN_LOCATION',
       EDIT_KANBAN_LOCATION: 'EDIT_KANBAN_LOCATION',
       DELETE_KANBAN_LOCATION: 'DELETE_KANBAN_LOCATION',
       SET_KANBAN_RULES: 'SET_KANBAN_RULES',
       ADD_KANBAN_RULE: 'ADD_KANBAN_RULE',
       EDIT_KANBAN_RULE: 'EDIT_KANBAN_RULE',
       DELETE_KANBAN_RULE: 'DELETE_KANBAN_RULE',
       SET_KANBAN_BOOKINGS: 'SET_KANBAN_BOOKINGS',
       ADD_KANBAN_BOOKING: 'ADD_KANBAN_BOOKING',
       EDIT_KANBAN_BOOKING: 'EDIT_KANBAN_BOOKING',
       DELETE_KANBAN_BOOKING: 'DELETE_KANBAN_BOOKING',
       SET_KANBAN_BOOKING_UI_FLAG: 'SET_KANBAN_BOOKING_UI_FLAG',
       SET_AGENDA_DATA: 'SET_AGENDA_DATA',
       SET_AGENDA_SELECTED_BOARDS: 'SET_AGENDA_SELECTED_BOARDS',
       SET_AGENDA_VIEW_MODE: 'SET_AGENDA_VIEW_MODE',
       SET_AGENDA_DATE_RANGE: 'SET_AGENDA_DATE_RANGE',
