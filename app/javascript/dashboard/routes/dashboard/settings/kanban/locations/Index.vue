...
<template>
  <SettingsLayout
    ...
    :no-records-found="!locations.length && !isLoading"
    :no-records-message="t('KANBAN.LOCATIONS_EMPTY')"
  >
    <template #header>
      <BaseSettingsHeader
        :title="t('KANBAN.LOCATIONS_TITLE')"
        :description="t('KANBAN.LOCATIONS_DESCRIPTION')"
      >
        <template #actions>
          <Button
            icon="i-lucide-plus"
    ...
    <template #body>
      <div class="grid gap-6">
        ...
        <div class="p-6 bg-n-solid-2 border border-n-weak rounded-lg">
          ...
          <div v-if="!locations.length" class="py-8 text-sm text-center text-n-slate-11">
